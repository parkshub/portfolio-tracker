...
exports.txCoin = async(req, res) => {
    ...
    // remember the user id should be coming from middleware
    ...
    // remember the use id should be coming from middleware req.user
    await UserModel.findByIdAndUpdate(coin.userId, {
